...
urlpatterns = [
    ...
    path('persona/', include(('persona.routers', 'persona'), namespace='personaAPI')),
    path('Rol/', include(('rol.urls', 'rol'), namespace='Rol')),
    path('rol/', include(('rol.routers', 'rol'), namespace='RolAPI')),
    path('Tiposcasos/', include(('tipocaso.urls', 'Tipocaso'), namespace='Tipocaso')),
    path('tiposcasos/', include(('tipocaso.routers', 'Tipocaso'), namespace='TipocasoAPI')),
    path('Usuario/', include(('usuario.urls', 'Usuario'), namespace='Usuario')),
    path('usuario/', include(('usuario.routers', 'UsuarioAPI'), namespace='UsuarioAPI')),    
    path('Detalleusuario/', include(('detalleusuario.urls','detalleusuario'), namespace='Detalleusuario')),
    path('detalleusuario/', include(('detalleusuario.routers','detalleusuario'), namespace='detalleusuarioAPI')),
    path('Detallecaso/', include(('detallecaso.urls','detallecaso'), namespace='Detallecaso')),
    path('detallecaso/', include(('detallecaso.routers','detallecaso'), namespace='detallecasoAPI')),
    path('Caso/', include(('caso.urls', 'caso'), namespace='Caso')),
    path('caso/', include(('caso.routers', 'caso'), namespace='CasoAPI')),
